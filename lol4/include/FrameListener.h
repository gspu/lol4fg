...
class CFrameListener : public Ogre::FrameListener, public OIS::KeyListener, public OIS::MouseListener, public Ogre::WindowEventListener/*, public KeyListener, public MouseMotionListener, public MouseListener*/
{
public:
	friend class GameApp;
    CFrameListener();//GameApp *_app, InputReader* inputReader,CEGUI::Renderer* renderer);//,/*Ogre::RenderWindow* win, Ogre::SceneManager* mgr, OgreNewt::World* W,*/ int update_framerate = 60);
	~CFrameListener();
