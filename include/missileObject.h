...
private:
	...
	void init(ObjectPtr caster, gamedata_damagedealer *source, Level *lvl, Ogre::Vector3 pos, Ogre::Quaternion ornt, Ogre::Vector3 v0 = Ogre::Vector3::ZERO,int SaveGameID = 0);
};
