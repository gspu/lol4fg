...
public:
	...
	{
		init(caster,target,castingItem,lvl,pos,effect_only,liveForever,ornt,scale);
	}
...
private:
	...
	void init(GameObject * caster,GameObject * target,gamedata_damagedealer *castingItem,Level *lvl,Ogre::Vector3 pos,bool effect_only = false, bool liveForever = false,Ogre::Quaternion ornt = Ogre::Quaternion::IDENTITY,Ogre::Vector3 scale = Ogre::Vector3::UNIT_SCALE,int SaveGameID = 0);
