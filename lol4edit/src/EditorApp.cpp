...
//void EditorApp::createCamera(void)
//{
//    // Create the camera
...
//	createCameraNodes();   
//}
//void EditorApp::createCameraNodes(void)
//{
...
//	{
//		mSceneMgr->destroySceneNode("CamHeadNode");
//	}
//	  
...
//void EditorApp::createScene(void)
//{
//	/*mSceneMgr->setAmbientLight(Ogre::ColourValue(1, 1, 1));
//	log("licht->kk");*/
//	//loadLvl("testscene2.xml");
//
//}
//
//void EditorApp::destroyScene(void)
//{
//
//
...
//void EditorApp::createViewports(void)
//{
...
//void EditorApp::setupResources(void)
//{
//
...
//	OgreNewt::Debugger::getSingleton().deInit();
        ...
        qtApp->getGameLogic()->deleteDecal();
...
//OgreNewt::Debugger::getSingleton().init( mSceneMgr );
	...
	CamHeadNode->pitch(Ogre::Degree(-90));
	qtApp->getGameLogic()->levelChanged();
...
//            return;//kein Terrainmodus ohne Terrain
//        CEGUI::Window *terrainwnd = wmgr->getWindow("editterrain");
//	    CEGUI::Window *objectwnd = wmgr->getWindow("objects");
//	    CEGUI::Window *curwnd = wmgr->getWindow("curobjects");
//        terrainwnd->enable();
...
////	updateTerrainWindow();
//        //das decal erstellen
//        qtApp->getGameLogic()->createDecal();
//        break;
//    }
//    editingMode = mode;
}
