...
//GamedataTreeItem should only be child of QTreeWidgetItem, and, since 
//their main purpose is to display a text and to hold gamedata, the constructor provides this
//also, only column 0 is used
class GamedataTreeItem: public QTreeWidgetItem
{
public:
	GamedataTreeItem(QTreeWidgetItem *parent, QString text, gamedata *data,int type = 0):
