...
void ObjectDetailsDialog::initObjectData()
{
	...
	*/
	...
	ui->posEdit->setText(ogre_str(mPos).c_str());
	ui->orientEdit->setText(ogre_str(q).c_str());
	ui->scaleEdit->setText(ogre_str(scale).c_str());

	ui->orientAxisEdit->setText(ogre_str(axis).c_str());
	ui->orientAngleEdit->setText(ogre_str(angle).c_str());
	...
	case otLight:
		{
			...
			//COlours
			liData->lightDiffuseColor->setText(ogre_str(l->getDiffuseColour()).c_str());
			liData->lightSpecularColor->setText(ogre_str(l->getSpecularColour()).c_str());
			//Attenuation
			liData->lightRange->setText(ogre_str(l->getAttenuationRange()).c_str());
			liData->lightConstant->setText(ogre_str(l->getAttenuationConstant()).c_str());
			liData->lightLinear->setText(ogre_str(l->getAttenuationLinear()).c_str());
			liData->lightQuadric->setText(ogre_str(l->getAttenuationQuadric()).c_str());
			//Spotlight
		
			liData->lightInner->setText(ogre_str(l->getSpotlightInnerAngle()).c_str());
			liData->lightOuter->setText(ogre_str(l->getSpotlightOuterAngle()).c_str());
			liData->lightFaloff->setText(ogre_str(l->getSpotlightFalloff()).c_str());	
	
			liData->lightPowerscale->setText(ogre_str(l->getPowerScale()).c_str());	
	...
	case otWater:			
		{		
			...
			//waterPlaneNormal->setText(ogre_str(fd.plane.normal).c_str());
//				waterPlaneConstant->setText(ogre_str(fd.plane.constant).c_str());
			waData->waterPlaneWidth->setText(ogre_str(fd.plane.width).c_str());
			waData->waterPlaneHeight->setText(ogre_str(fd.plane.height).c_str());
			waData->waterPlaneXSeg->setText(ogre_str(fd.plane.xSeg).c_str());
			waData->waterPlaneYSeg->setText(ogre_str(fd.plane.ySeg).c_str());
			waData->waterPlaneUpVector->setText(ogre_str(fd.plane.up).c_str());
			waData->waterPlaneVTile->setText(ogre_str(fd.plane.vTile).c_str());
			waData->waterPlaneUTile->setText(ogre_str(fd.plane.uTile).c_str());
			waData->waterPlaneTexCoords->setText(ogre_str(fd.plane.numTexCoordSets).c_str());

			waData->waterAngVisc->setText(ogre_str(fd.angularViscosity).c_str());
			waData->waterDensity->setText(ogre_str(fd.density).c_str());
			waData->waterLinVisc->setText(ogre_str(fd.linearViscosity).c_str());
	...
	case otStatic:
		{			
			...
			case WT_PLANE:
				...
				stData->planeNormal->setText(ogre_str(cur.pData.normal).c_str());
				stData->planeConstant->setText(ogre_str(cur.pData.constant).c_str());
				stData->planeWidth->setText(ogre_str(cur.pData.width).c_str());
				stData->planeHeight->setText(ogre_str(cur.pData.height).c_str());
				stData->planeXSeg->setText(ogre_str(cur.pData.xSeg).c_str());
				stData->planeYSeg->setText(ogre_str(cur.pData.ySeg).c_str());
				stData->planeUpVector->setText(ogre_str(cur.pData.up).c_str());
				stData->planeVTile->setText(ogre_str(cur.pData.vTile).c_str());
				stData->planeUTile->setText(ogre_str(cur.pData.uTile).c_str());
				stData->planeTexCoords->setText(ogre_str(cur.pData.numTexCoordSets).c_str());
...
void ObjectDetailsDialog::apply()
{
	...
	/*
	orientAxisEdit->setText(ogre_str(axis).c_str());
	orientAngleEdit->setText(ogre_str(angle).c_str());
	*/
