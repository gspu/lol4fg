...
namespace QtOgre
{
	...
	void EditGameLogic::levelChanged()
	{
		mCamera = app->getCurrentLevel()->getMainCam();
		selectedObject = NULL;
	...
	void EditGameLogic::initialise(void)
	{
       ...
       /* Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/fonts", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/materials/programs", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/materials/scripts", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/materials/textures", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/models", "FileSystem");*/
        //Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/overlays", "FileSystem");
        //Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/particle", "FileSystem");
 /*       Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/gui", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/DeferredShadingMedia", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/PCZAppMedia", "FileSystem");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/cubemap.zip", "Zip");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/cubemapsJS.zip", "Zip");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/dragon.zip", "Zip");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/fresneldemo.zip", "Zip");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/ogretestmap.zip", "Zip");
        Ogre::ResourceGroupManager::getSingleton().addResourceLocation("D:/ogre/OgreSDK/media/packs/skybox.zip", "Zip");
...
//				app->showDetailsDialog(selectedObject);
    ...
    {
        TiXmlDocument doc;
        Ogre::String str = app->getClipboardText();
        if(str != "")
        {
            doc.Parse(str.c_str());
	...
	Ogre::Ray EditGameLogic::getMouseRay()
	{
		...
		//mRealApp->logMessage("pos = ("+str(pos.x())+";"+str(pos.y())+")");
		//mRealApp->logMessage("wnd = ("+str(mWindow->getWidth())+";"+str(mWindow->getHeight())+")");
