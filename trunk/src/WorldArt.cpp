...
{
	Ogre::String name = "!plane:"+ogre_str(pData.width)+"/"+ogre_str(pData.height)
        +"/"+ogre_str(pData.xSeg)+"/"+ogre_str(pData.ySeg)
        +"/"+ogre_str(pData.normal)+"/"+ogre_str(pData.up)
        +"/"+ogre_str(pData.constant)+"/"+ogre_str(pData.numTexCoordSets)
        +"/"+ogre_str(pData.uTile)+"/"+ogre_str(pData.vTile);
	...
	name = "!plane:"+ogre_str(pData.width)+"/"+ogre_str(pData.height)
        +"/"+ogre_str(pData.xSeg)+"/"+ogre_str(pData.ySeg)
        +"/"+ogre_str(-pData.normal)+"/"+ogre_str(pData.up)
        +"/"+ogre_str(pData.constant)+"/"+ogre_str(pData.numTexCoordSets)
        +"/"+ogre_str(pData.uTile)+"/"+ogre_str(pData.vTile);
...
WorldArt::~WorldArt()
{
	...
	unsigned short num = mNode->numAttachedObjects();
	while(num)
	{
...
//{
//	Ogre::String ogre_str = XMLNode->Attribute("id");
//	pEntity->setUserAny(Any(ogre_str));
//}