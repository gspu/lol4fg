...
bool createPlaneMesh(Ogre::String name)
{
	...
	else
	{
		...
		/*mLog("konvertiert: xSeg="+str(xSeg)+", ySeg="+
			str(ySeg)+", width="+str(width)+
			" height="+str(height));*/
...
//
//
//Ogre::String str(Ogre::Real val, unsigned short precision, unsigned short width, char fill,
...
//Ogre::String str(Ogre::Radian val, unsigned short precision, unsigned short width, char fill,
//    std::ios::fmtflags flags )
//{
...
//Ogre::String str(Ogre::Degree val, unsigned short precision,
...
//Ogre::String str(int val, unsigned short width,char fill,std::ios::fmtflags flags)
//{
//	return Ogre::StringConverter::toString(val,width,fill,flags);
//}
//
///** Converts a size_t to a Ogre::String. */
//Ogre::String str(size_t val, unsigned short width, char fill, std::ios::fmtflags flags)
//{
//	return Ogre::StringConverter::toString(val,width,fill,flags);
//}
//
///** Converts an unsigned long to a Ogre::String. */
//Ogre::String str(unsigned long val, unsigned short width, char fill,
//    std::ios::fmtflags flags)
//{
//	return Ogre::StringConverter::toString(val,width,fill,flags);
//}
...
//Ogre::String str(long val, unsigned short width, char fill, std::ios::fmtflags flags)
//{
//	return Ogre::StringConverter::toString(val,width,fill,flags);
//}
//
...
//*/
//Ogre::String str(bool val, bool yesNo)
//{
...
//*/
//Ogre::String str(const Ogre::Vector2& val)
//{
...
//*/
//
//Ogre::String str(const Ogre::Vector3& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
//
//Ogre::String str(const Ogre::Vector3& val,bool newLines)
//{
//	if(newLines)
//	{
//		return str(val.x)+"\n"+str(val.y)+"\n"+str(val.z);
...
//*/
//Ogre::String str(const Ogre::Vector4& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
...
//*/
//Ogre::String str(const Ogre::Matrix3& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
...
//*/
//Ogre::String str(const Ogre::Matrix4& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
...
//*/
//Ogre::String str(const Ogre::Quaternion& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
...
//*/
//Ogre::String str(const Ogre::ColourValue& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
...
//    the output.
//*/
//Ogre::String str(const Ogre::StringVector& val)
//{
//	return Ogre::StringConverter::toString(val);
//}
